...
function callService(fields, constraints, sortFields) {
	...
	properties["basic.authorization.password"] = "XADMfluig2014";
...
function processResult(result) {
	...
	var nodes = xmlResponse.getElementsByTagName("PFunc");
...
function data() {
	return {
  "fluigService" : "HOST_wsDataServer",
  "operation" : "readView",
  ...
  "parameters" : [ ],
  "inputValues" : {
    "dataServerName" : "CRMFuncionarioData",
    "filtro" : "1=1",
    "contexto" : "CodUsuario=fluig"
  },
  "inputAssignments" : {
  ...
  "extraParams" : {
    ...
    "basicAuthenticationPassword" : "XADMfluig2014",
    "parseResult" : true,
    "headers" : [ ],
    "datasetkeys" : [ ],
    "parserType" : "XML",
