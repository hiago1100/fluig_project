const DAL = (function(){
    ...
    function startInstance(){
        ...
        /**
         * @description Consulta os dados de fornecedor do UAU
         * @param  {Function} callback [description]
         * @return {[json]}            [description]
         */
        function getFornecedorUAU(callback){
            let consulta;

            try{
                consulta = Model.get_DS1000('SP_FLUIG_1018', '').values;
                ...
                console.error("Houve um erro ao buscar os dados de fornecedor UAU!");
                console.error(ex);
                callback(false, null);
            }
        }
