...
function validateForm(form) {
  ...
  const faixa = value(form, 'faixa');

  const aprovadores = getChildren(form, 'aprovadores', ['aprovadorSeq', 'aprovadorCodUsuario', 'aprovadorDependente']);
  ...
  if (faixa == '') {
    throw 'A faixa deve ser informada.';
  }
