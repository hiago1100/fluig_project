...
var script = "SELECT a.cod_usuario, a.nome_usuario, b.cod_usuario AS cod_gest, b.nome_usuario as gest  FROM z_sga_usuarios a " +
"INNER JOIN z_sga_usuarios b " +
"on a.cod_gestor = b.cod_usuario ";

if(cod_usuario != ""){
  script = "SELECT a.cod_usuario, a.nome_usuario, b.cod_usuario AS cod_gest, b.nome_usuario as gest FROM z_sga_usuarios a " +
  "INNER JOIN z_sga_usuarios b " +
"on a.cod_gestor = b.cod_usuario " +
" WHERE a.cod_usuario LIKE '%"+ cod_usuario + "%' ";
}
if(nome_usuario != ""){
  script = "SELECT a.cod_usuario, a.nome_usuario, b.cod_usuario AS cod_gest, b.nome_usuario as gest FROM z_sga_usuarios a " +
  "INNER JOIN z_sga_usuarios b " +
"on a.cod_gestor = b.cod_usuario " +
" WHERE  a.nome_usuario LIKE '%"+ nome_usuario + "%'";
}
