  ...
  for(var i = 0;i<dsUsuarios.rowsCount;i++){
   // for(var i = 0;i<1;i++){
         ...
         var dsUsuariosGrupo = DatasetFactory.getDataset('ARY-sql2dataset-usuario-grupos', null, [c1],null);
            ...
            workflowEngineService.startProcess("admin", "fluig@2017!", 1, "ARY-Revisao_de_acessos", 0, colleaguesId, "Comentário: ", "admin", true, processAttachmentDtoArray, cardData, appointment, false);
