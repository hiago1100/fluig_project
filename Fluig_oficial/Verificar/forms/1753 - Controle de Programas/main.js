        ...
        onEdit: function(params) {  //Edição do formulário
            ...
            $("#selectProgramaRemove").on('change',function(){
            	...
            	if($("#selectProgramaRemove").val() == 'cod'){
                    $(".removeGrupoDesc").addClass('hide');
                    $(".removeGrupo").removeClass('hide');
            	}else {
            		 $(".removeGrupoDesc").removeClass('hide');
                     $(".removeGrupo").addClass('hide');
            	}
            });
            ...
            $('#btnRemoveGrupo').click(function(){
            	...
            	if(context.val() != ''){
            		...
            		$("#nomeProgAux___"+ultimaLinha).val($('#codProgramaRemoveAux').val());
                    $("#descProgAux___"+ultimaLinha).val($('#descProgramaRemoveAux').val());
        ...
        if (x.status == 500) {
         ...
         success:function(model) {
            ...
            $.each(model.content.values, function(index, value){
            	  var contadorConf = model.content.values.length ;
        ...
        success:function(model) {
            ...
            $.each(model.content.values, function(index, value){
                ...
                dadoss += ''+ nomeUsuario + '</button></a>';
                  ...
                  if (contador > 0) {
                dadoss += '<span align="center" class="badge badge-danger">' + contador + '</span>';    
