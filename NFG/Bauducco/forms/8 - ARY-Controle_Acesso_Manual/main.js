...
var indexObs = 0;
var carregaConf = FLUIGC.loading("#programasAdd");
...
function setSelectedZoomItem(selectedItem) {     
  ...
  if(selectedItem.inputName == "nomeEmpresa") {
    ...
    $("#gestorUsuario").val("Gestor usúario");
    $("#codGest").val("admin");
...
function carregaProgramasInc(id,cod_grupo){
  ...
  $.ajax({
    ...
    if (cod_grupo != "sup") { 
                ...
                programasInclusaoHtml += '<tr width="100%">';
                programasInclusaoHtml += '<td align="center">'; 
                programasInclusaoHtml += '';
                programasInclusaoHtml += '<a style="text-decoration: none;" class="collapse-icon up" data-toggle="collapse" data-parent="#accordion" href="#unidade'+ cod_grupo+'">';
