...
function createDataset(fields, constraints, sortFields) { 
    ...
    var cod_grupoAux = findConstraint("cod_grupoAux", constraints,"");
    
    var cod_grupo_add = findConstraint("cod_grupo_add", constraints,"");
    //var cod = 'dfaria';
    ...
    if(cod_grupo_add != ""){
        script = "select DISTINCT " +
                    ...
                    "desc_grupo     AS desc_grupo"+ 
                " from V_ARY_PROGRAMAS_USUARIO "+
                "WHERE cod_grupo = '"+cod_grupo_add+"' AND GR_CONFL IS NOT NULL ";
    }    
   ...
   if(cod_grupoAux != ""){
    ...
    "gr_confl       AS grupo_conflito " +
    " from V_ARY_PROGRAMAS_USUARIO "+
    "WHERE cod_usuario = '"+cod_grupoAux+"' AND GR_CONFL IS NOT NULL ";
