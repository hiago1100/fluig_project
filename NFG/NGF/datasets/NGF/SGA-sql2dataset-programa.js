...
function createDataset(fields, constraints, sortFields) {
 	...
 	var codEmpresa = findConstraint("codEmpresa",constraints,"");
 	 ...
 	 if(idPrograma != ""){	
 	 	var SQL = "SELECT prog.idGrupo, prog.cod_programa, prog.cod_grupo, p.descricao_programa, p.cod_programa from z_sga_grupo_programa as prog JOIN z_sga_programas as p on p.cod_programa = prog.cod_programa where prog.cod_programa = '"+idPrograma+"';";
