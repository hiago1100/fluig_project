...
function createDataset(fields, constraints, sortFields) {
 ...
 if(codUsuario != ""){ 	
 	var SQL = "SELECT g.idLegGrupo, g.descAbrev, (select ui.nome_usuario from z_sga_usuarios as ui where ui.cod_usuario = gs.gestor) as nomeGestor from z_sga_grupos as gs, z_sga_usuarios as u, z_sga_grupo as g where gs.idUsuario = '"+codUsuario+"' and g.idGrupo = gs.idGrupo and u.z_sga_usuarios_id = gs.idUsuario";
