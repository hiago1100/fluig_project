...
// 	if (form.getValue('cdFilialNS7') == null || form.getValue('cdFilialNS7') == "" || form.getValue('cdFilialNS7') == "-"){
// 		throw "Favor selecionar a Filial.";
// 	}
	
// 	if (form.getValue('cdAreaSol') == null || form.getValue('cdAreaSol') == "" || form.getValue('cdAreaSol') == "-"){
// 		throw "Favor selecionar a Área Solicitante.";
// 	}
	
// 	if (form.getValue('cdTipoCon') == null || form.getValue('cdTipoCon') == "" || form.getValue('cdTipoCon') == "-"){
...
// 	if ( (form.getValue('sAtivo') == null || form.getValue('sAtivo') == "") && (form.getValue('optAtivo') == "optCli" || form.getValue('optAtivo') == "optForn") ) {
// 		throw "Você deve escolher um Contratante.";
// 	}
	
// 	if ( (form.getValue('sPassivo') == null || form.getValue('sPassivo') == "") && (form.getValue('optPassivo') == "optCli" || form.getValue('optPassivo') == "optForn") ) {
// 		throw "Você deve escolher um Contratado.";
// 	}
	
// 	//Nova parte ativo
// 	if ( (form.getValue('sAtivo') == null || form.getValue('sAtivo') == "") && (form.getValue('optAtivo') == "optOutros") ) {
...
// 	//Nova parte passivo
// 	if ( (form.getValue('sPassivo') == null || form.getValue('sPassivo') == "") && (form.getValue('optPassivo') == "optOutros") ) {
// 		if  (form.getValue('sRazaoSocial') == null || form.getValue('sRazaoSocial') == ""){
// 			throw "Você deve informar a razão social da parte cadastrada.";
// 		}
...
// 	if ( form.getValue('sCnpj') != null && form.getValue('sCnpj') != "" ) {
// 		//valida cpf/cpnj
