function validateForm(form)
{
    ...
    var regras_do_formulario = [ 
        ...
        { campo: 'cpRecolhimentoObraDataAdmissao', label: 'Data de Admissão', atividades: atv_recolhimento_obra, regras: ['obrigatorio']},
        { campo: 'cpCadExternoSituacao', label: 'Situação', atividades: atv_recolhimento_obra, regras: ['obrigatorio'] },
        { campo: 'cpCadExternoSeguroDesemprego', label: 'O candidato está em vias de percepção de seguro desemprego?', atividades: atv_recolhimento_obra, regras: ['obrigatorio']},
