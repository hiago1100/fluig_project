        ...
        if(tbDesvinculado[0].txtCodItemProdutoDesv != '' &&
          ...
          if(arrVencedoresCotacao[i].codFornecedor == tbCotacoes[j].codFornecedorCotacao &&
            ...
            var item = formataSeqProtheus(tbCotacoes[j].SeqItemCotacao,4);
        		...
        		var pedidoCorporativo =  hAPI.getCardValue("pedidoCorporativo") == '1' ? '1' : '2';
            var strItem = "<Iten>"+
      	...
      	var dsPedido = DatasetFactory.getDataset('ds_pedidoCompra',[xmlPedido],null, null);
...
function consultaPedidoExistente(fornecedor){
  ...
  var constraintPedidoCompra2 = DatasetFactory.createConstraint('IDFLUIG', numProcess, numProcess, ConstraintType.MUST);
  var constraintPedidoCompra3 = DatasetFactory.createConstraint('CODFORNECEDOR', fornecedor, fornecedor, ConstraintType.MUST);
  var ds_pedidoCompra = DatasetFactory.getDataset('ds_consultaPedidoCompra', null, [constraintPedidoCompra,constraintPedidoCompra2,constraintPedidoCompra3], null);
