function beforeTaskSave(colleagueId,nextSequenceId,userList){
	...
	if (currentState == ATIVIDADE_COTACAO){
		...
		if (prioridadeCotacao.indexOf(hAPI.getCardValue('hiddenPrioridadeSolicitacao')) != -1 && hAPI.getCardValue('rdTipoCotacao') == 'fechada' && hAPI.getCardValue("grupoAnaliseComprador") != "Pool:Group:CM") {
