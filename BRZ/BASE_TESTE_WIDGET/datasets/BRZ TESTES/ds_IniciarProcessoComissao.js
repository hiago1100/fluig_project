...
function iniciarprocesso(numvend, empreendimento,corduser) {
   ...
   // var query = "SELECT * FROM FLUIG_DEV.DBO.BRZ_COMISSAO WHERE DATAVENDA BETWEEN '"+pastWeekDate()+"' AND '"+todayDate()+"' ORDER BY NUM_VENDA, COD_COMPN DESC";  
    ...
    /*
    var query = "SELECT * FROM FLUIG_DEV.DBO.BRZ_COMISSAO WHERE DATAVENDA BETWEEN '2019-02-28' AND '2019-02-28' ORDER BY NUM_VENDA, COD_COMPN DESC";
    ...
    */
    ...
    var query = "SELECT * FROM FLUIG_DEV.DBO.BRZ_COMISSAO WHERE DATAVENDA BETWEEN '2019-01-01' AND '2019-04-01' ORDER BY NUM_VENDA, COD_COMPN DESC";
    ...
    for(i=0; i<arr.length; i++){
        ...
        var matricula_aprovador = 'App.Fluig@3461'; //hAPI.getAdvancedProperty("integrador-userid");

        var username = 'App.Fluig@3461'//'adiasadmin'; //hAPI.getAdvancedProperty("ws-login");
        ...
        if(corduser != ""){
        	...
        	colleagueIds.getItem().add('App.Fluig@3461');
        	userId = 'App.Fluig@3461';
