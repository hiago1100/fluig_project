...
function getEmprendimentosConsolidados(idSelect, type) {
    ...
    var query = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_BRUTO"
...
function executeDBSearchNFS(ini, fim){
    ...
    var query = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_BRUTO WHERE PeriodoIni = '"+ini+"' AND PeriodoFin = '"+fim+"'";
...
function getConsolidated(val1, val2, val3, val4, x){
    ...
    // var query = "SELECT * FROM FLUIG_DEV.DBO.ML0012472 WHERE (cpDate1ParcelaComissao BETWEEN '"+val1+"' AND '"+val2+"' OR cpDate2ParcelaComissao BETWEEN '"+val1+"' AND '"+val2+"' OR cpDateBonus BETWEEN '"+val1+"' AND '"+val2+"' OR cpDateDemandaMin BETWEEN '"+val1+"' AND '"+val2+"' OR cpDateDemandaMax BETWEEN '"+val1+"' AND '"+val2+"' OR cpDateDistrato BETWEEN '"+val1+"' AND '"+val2+"' OR cpDateComBRZ BETWEEN '"+val1+"' AND '"+val2+"') AND cpEmpreendimentoCod = '"+val3+"' AND cpNomeImobiliaria = '"+imob+"'"
    // var query = "SELECT * FROM FLUIG_DEV.DBO.ML0012472 WHERE (cpDate1ParcelaComissao BETWEEN '"+val1+"' AND '"+val2+"' OR cpDate2ParcelaComissao BETWEEN '"+val1+"' AND '"+val2+"' OR cpDateDistrato BETWEEN '"+val1+"' AND '"+val2+"' OR cpDateComBRZ BETWEEN '"+val1+"' AND '"+val2+"') AND cpEmpreendimentoCod = '"+val3+"' AND cpNomeImobiliaria = '"+imob+"'"
    var query = "SELECT * FROM FLUIG_DEV.DBO.ML0012472 A JOIN DOCUMENTO B ON A.documentid = B.NR_DOCUMENTO AND A.version = B.NR_VERSAO AND B.VERSAO_ATIVA = 1 WHERE (cpDate1ParcelaComissao BETWEEN '"+val1+"' AND '"+val2+"' OR cpDate2ParcelaComissao BETWEEN '"+val1+"' AND '"+val2+"' OR cpDateDistrato BETWEEN '"+val1+"' AND '"+val2+"' OR cpDateComBRZ BETWEEN '"+val1+"' AND '"+val2+"') AND cpEmpreendimentoCod = '"+val3+"' AND cpNomeImobiliaria = '"+imob+"'"
...
function consultDB(imob, type){
    ...
    console.log("TESTE DO EMAIL IMOB"+ imob);
    ...
    if(type == "bruto"){
        consult = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_BRUTO ORDER BY ID ASC";
    }else if(type == "parc1"){
        consult = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_PPARC ORDER BY ID ASC";
    }else if(type == "parc2"){
        consult = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_SPARC ORDER BY ID ASC";
    }else if(type == "parcU"){
        consult = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_PARCU ORDER BY ID ASC";
    }else if(type == "dist"){
        consult = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_PARCD ORDER BY ID ASC";
    }

    if(type == "remove_bruto"){
        consult = "DELETE FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_BRUTO";
    }else if(type == "remove_parc1"){
        consult = "DELETE FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_PPARC";
    }else if(type == "remove_parc2"){
        consult = "DELETE FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_SPARC";
    }else if(type == "remove_parcU"){
        consult = "DELETE FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_PARCU";
    }else if(type == "remove_dist"){
        consult = "DELETE FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_PARCD";
    }else if(type == "remove_dist_saldo"){
        consult = "DELETE FROM FLUIG_DEV.DBO.FLUIG_ARMAZENA_DISTR";
    }

    if(type == "distrato"){
        consult = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_ARMAZENA_DISTR WHERE Imobiliaria = '"+imob[0]+"' AND Empreendimento = '"+imob[1]+"' ";
    }else if(type == "distratoConsulta"){
        consult = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_ARMAZENA_DISTR";
    }

    if(type == "BRZ_COMISSAO"){
        consult = "SELECT * FROM FLUIG_DEV.DBO.BRZ_COMISSAO WHERE NUM_VENDA = '"+imob+"'";
        // consult = "SELECT * FROM FLUIG_DEV.DBO.BRZ_COMISSAO WHERE NUM_VENDA = '10362'";
    }

    if(type == "ALTER"){
        consult = "ALTER TABLE FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_BRUTO ADD NF VARCHAR(255) NULL";
    }


    if(type == "ML"){
        consult  = "SELECT * FROM FLUIG_DEV.DBO.ML0012472 WHERE cpDate1ParcelaComissao BETWEEN '2018-11-28' AND '2018-11-28' OR cpDate2ParcelaComissao BETWEEN '2018-11-28' AND '2018-11-28' OR cpDateBonus BETWEEN '2018-11-28' AND '2018-11-28' OR cpDateDemandaMin BETWEEN '2018-11-28' AND '2018-11-28' OR cpDateDemandaMax BETWEEN '2018-11-28' AND '2018-11-28' OR cpDateDistrato BETWEEN '2018-11-28' AND '2018-11-28' AND cpEmpreendimentoCod = '40' AND cpNomeImobiliaria = 'VIK IMÓVEIS' ORDER BY cpNumeroVenda DESC"
    }

    if(type == "distratoCol"){
        consult = "ALTER TABLE FLUIG_DEV.DBO.FLUIG_ARMAZENA_DISTR ADD Empreendimento VARCHAR(255) NULL";
    }

    if(type == "banco"){
        consult = "SELECT * FROM FLUIG_DEV.DBO.BRZ_COMISSAO WHERE NUM_VENDA = '9447'";
    }

    if(type == "consultType"){
        consult  = "SELECT * FROM FLUIG_DEV.DBO.ML0012472 WHERE documentid = '"+imob+"'";
    }

    if(type == "removeForm"){
        consult = "DELETE FROM FLUIG_DEV.DBO.ML0012472";
    }

    if(type == "consultSale"){
        consult = "SELECT * FROM FLUIG_DEV.DBO.BRZ_COMISSAO WHERE DATAVENDA BETWEEN '2019-02-05' AND '2019-02-06' ORDER BY DATAVENDA DESC"
    }
    if(type == "consultSaleDs"){
        consult = "SELECT * FROM FLUIG_DEV.DBO.ML0012472 ORDER BY cpNumeroVenda DESC"
    }
...
function updateTableConsolidated(obj, type, upd){
    ...
    if(type == "bruto" || type == 'NFConsolidado'){
        query = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_BRUTO ORDER BY ID ASC";
    }else if(type == "parc1"){
        query = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_PPARC ORDER BY ID ASC";
    }else if(type == "parc2"){
        query = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_SPARC ORDER BY ID ASC";
    }else if(type == "parcU"){
        query = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_PARCU ORDER BY ID ASC";
    }else if(type == "dist"){
        query = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_PARCD ORDER BY ID ASC";
    }else if(type == "dist_saldo"){
        query = "SELECT * FROM FLUIG_DEV.DBO.FLUIG_ARMAZENA_DISTR ORDER BY Imobiliaria ASC";
    }
    ...
    $.ajax({
      ...
      success : function(data){
        ...
        if(type == "bruto"){
            ...
            if(st){
                qry  = " INSERT INTO FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_BRUTO  (ID, PeriodoIni, PeriodoFin, Imobiliaria, Empreendimento, ValorBruto, Desconto, Despesas, ValorNF, DocumentID)";
        ...
        if(type == "dist"){
            ...
            for(i=0; i<Object.keys(obj["Bloco"]).length; i++){
                ...
                if(!upd){
                    qry  = " INSERT INTO FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_PARCD (ID, DataVenda, NumVenda, Empreendimento, Bloco, Unidade, NomeCliente, NomeImobiliaria, NomeCorretor, TipoVenda, NotaFiscal, ValorDistrato, TotalDistrato)";
        ...
        if(type == "dist_saldo"){
            ...
            if(!st){
                qry  = " INSERT INTO FLUIG_DEV.DBO.FLUIG_ARMAZENA_DISTR (Imobiliaria, Empreendimento, SaldoDistrato)";
                qry += " VALUES('"+obj.NomeImobiliaria+"', '"+obj.Empreendimento+"', '"+obj.saldoDistrato+"')";
            }else{
                qry  = " UPDATE FLUIG_DEV.DBO.FLUIG_ARMAZENA_DISTR SET SaldoDistrato = '"+obj.saldoDistrato+"' WHERE Imobiliaria = '"+obj.NomeImobiliaria+"' AND Empreendimento = '"+obj.Empreendimento+"'";
            }
        ...
        if(type == 'NFConsolidado'){
            qry  = " UPDATE FLUIG_DEV.DBO.FLUIG_CONSOLIDADOS_BRUTO SET NF = '"+obj.NF+"' WHERE ID= '"+obj.ID+"'";
            var dt = { 
              "name" : "ds_buscaDB", //dataset's id 
              "constraints" :[{ //constraints to filter the search, all fields specified inside are required 
                    "_field" : "SQL", //name of the field used in the constraint 
...
for(var i = 0; i < rest_solicitacoes.length; i++) {                    
    ...
    "constraints": [
        {
            "_field": "slctEmpreendimento",
            "_initialValue": rest_solicitacoes[i] ,
            "_finalValue": rest_solicitacoes[i] ,
            "_type": 1
        }
    ]
};
