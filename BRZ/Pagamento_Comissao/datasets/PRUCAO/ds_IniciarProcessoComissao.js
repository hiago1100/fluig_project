...
function iniciarprocesso(numvend, empreendimento,corduser) {
    ...
    /*
    var query = "SELECT * FROM FLUIG.DBO.BRZ_COMISSAO WHERE DATAVENDA BETWEEN '2019-02-28' AND '2019-02-28' ORDER BY NUM_VENDA, COD_COMPN DESC";
  ...
  // var query = "SELECT * FROM FLUIG.DBO.BRZ_COMISSAO WHERE DATAVENDA BETWEEN '2019-04-08' AND '2019-04-09' ORDER BY NUM_VENDA, COD_COMPN DESC";
    ...
    for(i=0; i<arr.length; i++){
        ...
        var matricula_aprovador = 'Brz@3461'; //hAPI.getAdvancedProperty("integrador-userid");

        var username = 'Brz@3461'//'adiasadmin'; //hAPI.getAdvancedProperty("ws-login");
        ...
        if(corduser != ""){
            ...
            colleagueIds.getItem().add('Brz@3461');
            userId = 'Brz@3461';
