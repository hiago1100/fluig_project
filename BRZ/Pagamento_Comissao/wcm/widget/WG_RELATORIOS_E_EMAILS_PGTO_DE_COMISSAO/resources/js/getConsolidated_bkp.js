        ...
        success: function(data) {
            ...
            for (var i = 0; i < data.content.values.length; i++) {
                ...
                if(documentid.indexOf(data.content.values[i].documentid) === -1 && imobiliaria == data.content.values[i].cpNomeimobiliaria && empreendimento && empreendimento != "undefined" && valComissao && valComissao != "0,00"){
                    ...
                    console.log("cpValorTotalDeComissao", cpValorTotalDeComissao);
                    console.log("cpValor1ParcelaComissao", cpValor1ParcelaComissao);
                    console.log("cpValor2ParcelaComissao", cpValor2ParcelaComissao);
                    console.log("cpValorParcelaUnica", cpValorParcelaUnica);
                    console.log("cpValordeDistrato", cpValordeDistrato);
        ...
        success: function(data) {
            ...
            for (var i = 0; i < data.content.values.length; i++) {
                ...
                if(documentid.indexOf(data.content.values[i].documentid) === -1 && imobiliaria == data.content.values[i].cpNomeimobiliaria && empreendimento && empreendimento != "undefined" && valComissao && valComissao != "0,00"){
                    ...
                    console.log("inside imobiliaria", imobiliaria,"-",data.content.values[i].cpNomeimobiliaria);
                    console.log("inside empreendimento", empreendimento);
                    console.log("inside valComissao", valComissao);
        ...
        success: function(data) {
            ...
            for (var i = 0; i < data.content.values.length; i++) {
                ...
                if(documentid.indexOf(data.content.values[i].documentid) === -1 && imobiliaria == data.content.values[i].cpNomeimobiliaria && empreendimento && empreendimento != "undefined" && valDist && valDist != "0,00"){
                    ...
                    if(empreendimento != null && empreendimento != "" && empreendimento != 'undefined' && empreendimento != undefined){
                        empreendimento  = data.content.values[i].cpEmpreendimento;
                        empreendimento2 = data.content.values[i].cpEmpreendimento;
                    }
