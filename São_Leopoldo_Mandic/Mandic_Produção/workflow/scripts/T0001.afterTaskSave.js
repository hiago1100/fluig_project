function afterTaskSave(colleagueId,nextSequenceId,userList){
  ...
  var Finalizar  = getValue("cbkFinalizar");
  var frete      = getValue("txtValorFrete");
  var desconto   = getValue("txtValorDesconto");

   log.info("*** CRM *** - Everton Cancelou "+Finalizar);
    ...
    if ((activity == 4) || (activity == 0)){
      ...
      // if ( frete == null ){ hAPI.setCardValue("txtValorFrete","0,00"); }
      // if ( desconto == null ){ hAPI.setCardValue("txtValorDesconto","0,00"); }
       ...
       try{
           ...
           if (result.length > 20){
             ...
             throw mensagemErro; 
                  ...
                  log.info("*** CRM *** AFTERSAVE IDMOV SALVAR"+idmov); 
