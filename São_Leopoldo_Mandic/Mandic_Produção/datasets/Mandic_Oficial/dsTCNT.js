...
function createDataset(fields, constraints, sortFields) {
    ...
    if (constraints != null) {
     ...
     //               "FROM  (SELECT L.CODTMV, C.IDCNT, CODCPG, C.CODIGOCONTRATO+' - '+C.NOME+' - '+ F.NOMEFANTASIA CONTRATO, C.CODIGOCONTRATO, C.CODCOLIGADA , U.CODUSUARIO, C.CODCCUSTO, C.CODCOLCFO, C.CODCFO, G.CODFILIAL"+  
     //               "FROM TCNT C (NOLOCK)  "+
