function displayFields(form,customHTML) 
{
	...
	var arrayCamposData = ["cpDataPagamento",
		"cpInicioPeriodoAquisitivo",
		"cpFimPeriodoAquisitivo",
		"cpDataAdmissao",
		"cpDtNascimento"
    	];
	
	var indexes = form.getChildrenIndexes("DatasFerias");
    for (var i = 1; i < indexes.length; i++) 
    {
    	arrayCamposData.push('cpDataInicioFerias___'+i)
    }
